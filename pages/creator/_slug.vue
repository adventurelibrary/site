<template>
	<article class="asset item-page" v-if="asset">
        ...
        https://www.notion.so/adventurelibrary/DS-v1-1-dc7e75db0fec48c09062f8ef0060d91e
...
import CreatorAbout from './_slug copy.vue';
...
class AssetPage extends Vue {
  creator : Creator
	...
	async fetch () {
    	//this.creator = await get
	//	this.asset = await getCreatorById(this.$nuxt.context.params.slug)
